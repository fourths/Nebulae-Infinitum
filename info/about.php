<html>
	...
	<body>
		...
		<div class="container" style="padding-bottom:20px;">
			...
			<p>In fall 2011, Alternatives, ProgrammingFreak, 777w, and TheDancingDonut created <a href="http://xat.com/TheGalaxyBox">TheGalaxyBox</a>, a chatroom on xat in which they could talk amongst themselves as well as with various people on Scratch they invited. bananaman114, soupoftomato, and various others were amongst those included. While two of the original members, Alt and TDD, gradually stopped using it, others who were invited started to invite guests of their own&mdash;Wickmen, 777w, veggieman001 and his brother puppetadventurer, and rufflebee. Eventually, around the beginning of 2012, the core group of TheGalaxyBox was mostly Wicki, soup, 777w, and veggie, with ruffle on occasion.</p>
			<p>At some point, we decided that perhaps we'd like to find another online community besides Scratch to bother. However, after some searching, we found none suitable. This was when the idea to create our own was born, devised in June 2012 mainly by 777w and soup. Dubbed Nebulae Infinitum ("infinite clouds" in Latin), they enlisted veggie's help and his programming knowledge to create the site. This was when the creation of the site began.</p>
			<p>However, we no longer use TheGalaxyBox for communication. Since a technical difficulty that arose with one of our core members, we switched to Gmail and Google Docs in August. luiysia joined not long after, and we began working on another project, <a href="http://nebbins.netai.net/">Nebbins Magazine</a> before it fell apart at the end of 2012.</p>
