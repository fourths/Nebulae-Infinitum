...
<?
if ($creation['filetype']=="sb2" && $cur_user[16]=="js") echo '<script type="text/javascript" src="data/sb2js/script/ZipFile.complete.js">
</script>
...
<script type="text/javascript" src="data/sb2js/script/sb2.js">
</script>';
else echo '<script type="text/javascript" src="data/jquery.js"></script>';
?>
...
//sb2js init
autoLoad = "data/projects/<?=$creation['filename']?>";
basedir = "data/sb2js/"
...
<div class="cleft">
<div class="ccontainer" style="width:486px;margin-left:5px;margin-top:5px;">

<? if ($creation['filetype']=="sb2" && $cur_user['sb2player']=="js") echo '<canvas id="scratch" width="486" height="391" tabindex="1"><div style="padding:10px;">Your browser doesn\'t support sb2.js.</div></canvas>';

else echo '<object style="width:482px;height:387px;position:relative;left:0px;top:0px;margin-left:3px;margin-top:2px;" type="application/x-shockwave-flash" data="data/PlayerOnly.swf">
<param name="allowScriptAccess" value="always"><param name="allowFullScreen" value="true">
<param name="flashvars" value="project=data/projects/'.$creation['filename'].'"></object>';
?>
