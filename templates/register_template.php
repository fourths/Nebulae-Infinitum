...
<form method="post">
<label style="margin-right:5px;" for="user">Username:</label><input type="text" name="user" value="<?php echo $_POST['user']; ?>"/><br/>
...
<label style="margin-right:32px;" for="email">Email:</label><input type="email" name="email" value="<?php echo $_POST['email']; ?>"/><br/>
The following fields are optional.<br/>
<label style="margin-right:43px;" for="age">Age:</label><input type="text" name="age" value="<?php echo $_POST['age']; ?>"/><br/>
...
<label style="margin-right:17px;" for="location">Location:</label><input type="text" name="location" value="<?php echo $_POST['location']; ?>"/><br/>
<br/>
