...
<div class="container">
	...
	<input type="file" name="creationfile" accept="application/x-shockwave-flash,application/x-scratch-project,application/octet-stream,application/zip,application/x-zip,application/x-zip-compressed,audio/mpeg,audio/x-mpeg,audio/mpeg3,audio/x-mpeg-3,video/mpeg,video/x-mpeg,image/bmp,image/png,video/png,image/x-png,image/tiff,image/x-tiff,image/x-jpeg,image/pjpeg,image/gif,image/jpeg,image/x-gif,image/svg+xml,text/plain"/><? // by extension?? ?>
	<br/>(<a href="info/filetypes.php">What filetypes are okay?</a>)<br/>
	<input type="file" name="thumbnail" accept="image/png">
	<br/>PNG thumbnail for non-image uploads<br/>
	<div>
	Licensed under 
