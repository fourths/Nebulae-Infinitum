...
<div class="cleft">
	<div class="ccontainer">
		<div class="creation">
			<div class="flashblock" style="padding-bottom:5px;">
				<div class="flashwrapper" style="padding-bottom:72.7272727273%">
					<object style="border:1px solid;" class="flash" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="editorObj"codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab">
						<param name="movie" value="data/creations/15.swf" />
						<param name="quality" value="high" />
						<param name="bgcolor" value="#ffffff" />
						<embed id="editor" src="data/creations/15.swf" quality="high" bgcolor="#ffffff"
							scale="exactfit"
							play="true"
							loop="false"
							quality="high"
