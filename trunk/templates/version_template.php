					...
					foreach($versions as $version){
						...
						//don't forget to do the saved thing for current versions on the edit.php thing
							if($version['saved']==1){
								...
								echo '<td class="versionrow" style="width:400px;"><a href="version/'.$version['number'].'/revert">Revert</a> <a href="../../data/creations/old/'.$filenames[$version['number']].'">Download</a> <a href="version/'.$version['number'].'/delete">Delete</a></td>';
							}
							else{
