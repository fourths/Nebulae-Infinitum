...
This is generally caused by having Javascript disabled or using a browser that doesn't support HTML5 canvas. This can be fixed by either enabling Javascript in the first case, or updating your browser to the latest version or getting a new browser in the second. (We recommend Google Chrome or Mozilla Firefox.)<br/><br/>

<strong>Why can't I use it for Scratch 1.x projects?</strong><br/>
sb2.js doesn't support sb files yet, although it is planned for the future once Scratch 2.0 projects are completely finished.<br/><br/>

<strong>Why doesn't this feature work like in the Flash player?</strong><br/>
sb2.js is still in active development, and there are several things that need to be done still. It is recommended that you report bugs with the player <a href="http://code.google.com/p/sb2-js/issues/list">here</a> so that RHY is aware of them. This will help with the development of the player!<br/><br/>

<strong>There's a feature that works on RHY's Dropbox site but not here!</strong><br/>
This means that RHY has probably updated the player and we just haven't gotten around to updating our copy yet. <a href="mailto:<?=ADMIN_EMAIL?>">Email us</a> or send a message to one of the admins.<br/><br/>

<strong>Can I force users to use sb2.js on one of my projects?</strong><br/>
