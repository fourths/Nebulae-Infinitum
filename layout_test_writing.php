...
<div class="cleft">
	<div class="ccontainer">
		<div class="creation">
			<div class="wcontent" style="font-size:13px;" id="resizeable">
				<div class="resizebuttons"><a href="javascript:resize(2);" class="plus"></a><a href="javascript:resize(-2);" class="minus"></a></div>
				These are words that would go here
			</div>
		</div>
